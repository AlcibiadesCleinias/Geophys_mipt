...
dt = 8.5e-7 # Шаг по времени
Nt = 80001 #Количетство шагов по времени в расчете
save = 500 #Частота сохранений - подробнее в файле "задание"
Nt_soft_half = 20000 #количество шагов по времени, за которые происходит плавное возрастание давления поезда на рельс

h_y = 0.005 "вертикальный шаг в рельсе, шпалах и насыпи
h_x = 0.01 "горизонтальный шаг и шаг в земле

V_train = 15.0*0.277778 # скорость вагона/локомотива в м/c, 
#90.0 - gruzeny, 100 - porozny, 120 - 140 - passajirsky, 160 - 200 - Moscow - SPt

P_norm = 1.88e8 #давление поезда "в норме", вычисляется по формуле из статьи, екселевский файл, куда она вбита, прилагаю.
F_norm = 165375 #сила, из того же файла
if_polzun = 1 #0 - нет ползуна, 1 - есть ползун
h_polzun = 2.0/1000.0 #глубина ползуна в м
eps = 0.001 #епсилон из статьи
J_rail = 553.55 #момент инерции колесной пары kg*m2
R_wheel = 0.475 #радиус колеса
dis_polzun = 0.0 #расстояние на ободе колеса, на котором начинается ползун < Pi*R_wheel*2

dis_between_wheels = 1.850 #расстояние между ближайшими колесами
dis_between_wheels_long = 8.150 #расстояние между дальними колесами
n_x_impulse = 5 #минимальное количество точек в контакте колеса и рельса
...
sleeper_height = 0.180 #высота шпалы, здесь и далее величины в метрах
sleeper_wigth = 0.250 #ширина шпалы
sleeper_into_embankment = 0.120 #насколько шпала "провалилась" в насыпь

embankment_height = 0.25 #высота насыпи под шпалой
earth_height = 2.0 #толщина грунта под насыпью, которая считается

N_sleepers = 46 #количество шпал
rail_length = 25.0 #длина рельса
dis_butt_sleepers = 0.420 #расстояние между шпалами на стыке двух разных рельсов
rail_height = 0.180 #высота рельса, 152 mm - P50, 180 mm - P65, 181 mm - P65K, 192 mm - P75

c1_steel = 5740.0 #скорость P-волн в стали рельса
c2_steel = 3092.0 #скорость S-волн в стали рельса
rho_steel = 7800.0 #плотность стали рельса
max_tension_steel = 7.8e8 #прочность (максимальное главное напряжение) стали рельса, 5e8 #300 - 600 MPa

c1_sleeper = 1000.0 #скорость P-волн в шпале
c2_sleeper = 500.0 #скорость S-волн в шпале
rho_sleeper = 400.0 #плотность шпалы

c1_embankment = 800.0 #скорость P-волн в насыпи, 100 - 1000, 1000 влажный гравий
c2_embankment = 400.0 #скорость S-волн в насыпи
rho_embankment = 2000.0 #плотность насыпи

c1_earth = 2000.0 #скорость P-волн в грунте под насыпью
c2_earth = 1000.0 #скорость S-волн в грунте под насыпью
rho_earth = 2000.0 #плотность грунта под насыпью


#КОНЕЦ ВАРЬИРУЕМЫХ ПАРАМЕТРОВ
